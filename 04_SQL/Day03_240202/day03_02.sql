...
length(vchar_fld a) as vachear_length,
lendgth(text_fld) as text_length
from string_tbl st; ;

#position() 함수
select position('characters' in vchar _fld)
from string_tbl;
...
#strcmp('문자열', '문자열2') 함수 : 문자열 비교
delete from string_tbl; #테이블은 두고 안에 내용만 지우는 거. drop은 테이블도 지움

insert into string_tbl(vchar_fld)
values ('abcd'), ('xyz'), ('QRSTUV'),('qrstv'), ('12345');
